        ...
        >
          {benefits.map(({ icon: Icon, title, desc }, i) => (
            <motion.div
              key={title}
              variants={fadeUp}
              className="group rounded-xl p-6 bg-white border border-gray-100 hover:border-gray-200 hover:shadow-md transition-shadow"
            >
              <div
              ...
              >
                <Icon className="w-5 h-5" style={{ color: i % 2 === 0 ? "#000" : "#CCFF33" }} />
              </div>
              <h3 className="font-extrabold text-black mb-2 text-sm leading-snug">{title}</h3>
